export const en = {
  ...
  myVpn: {
    ...
    expired: "expired",
    noDeviceYet: "Your device is still being set up - check back shortly.",
    awaitingProvisioning: "Your first device hasn't been provisioned yet - this usually only takes a moment, but check back if it's been a while.",
    addDevice: "Add Device ({current}/{limit})",
    deviceAdded: "Device added",
    addDeviceFailed: "Couldn't add device",
