  ...
  React.useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const url = `https://api.etherscan.io/v2/api?chainid=${PRIMARY_CHAIN_ID}&module=account&action=txlist&address=${windowAddress}&startblock=0&endblock=99999999&sort=desc&page=1&offset=50&apikey=${BSCSCAN_API_KEY}`;
